...
Этот проект, по которому вы сможете создать похожий видеоплеер.

![max example](screenshots/max.gif)

Построен на базе библиотеки [Playable](https://wix.github.io/playable/).

Если вы хотите точно такой же видеоплеер, то просто скачайте репозиторий, всё находится в готовом виде.

Ниже вы узнаете как его создать.
## Как подключить

Пример минимальных настроек - [min_example](./example-min.html)
